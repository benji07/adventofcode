...
class XmasCipher
{
    public function getInvalid(int $preambleSize, array $data): ?string
    {
    ...
    public function isValid(array $preamble, string $value): bool
    {
    ...
    public function findEncryptionWeekness(array $data, string $invalidInput): int
    {
        $length = count($data);
